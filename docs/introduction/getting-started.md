...
You can download Clash core binaries here: [https://github.com/thkx/clash/releases](https://github.com/thkx/clash/releases)
...
For other build targets, check out the [Makefile](https://github.com/thkx/clash/blob/master/Makefile).
