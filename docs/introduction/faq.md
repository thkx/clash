...
Here we have some common questions people ask. If you have any questions not listed here, feel free to [open an issue](https://github.com/thkx/clash/issues/new/choose).
...
- NETGEAR WNDR3700v2: mips-hardfloat [#846](https://github.com/thkx/clash/issues/846)
- NETGEAR WNDR3800: mips-softfloat [#579](https://github.com/thkx/clash/issues/579)
- ASUS RT-AC5300: armv5 [#2356](https://github.com/thkx/clash/issues/2356)
- MediaTek MT7620A, MT7621A: mipsle-softfloat ([#136](https://github.com/thkx/clash/issues/136))
- mips_24kc: [#192](https://github.com/thkx/clash/issues/192)
...
- [Snell](https://github.com/thkx/clash/issues/2466)
- [Custom CA](https://github.com/thkx/clash/issues/2333)
- [VMess Mux](https://github.com/thkx/clash/issues/450)
- [VLess](https://github.com/thkx/clash/issues/1185)
- [KCP](https://github.com/thkx/clash/issues/16)
- [mKCP](https://github.com/thkx/clash/issues/2308)
- [TLS Encrypted Client Hello](https://github.com/thkx/clash/issues/2295)
- [TCP support for Clash DNS server](https://github.com/thkx/clash/issues/368)
- [MITM](https://github.com/thkx/clash/issues/227#issuecomment-508693628)

The following will be considered implementing when the official Go QUIC library releases.

- [TUIC](https://github.com/thkx/clash/issues/2222)
- [Hysteria](https://github.com/thkx/clash/issues/1863)
...
Refer to this discussion: [#422](https://github.com/thkx/clash/issues/422)

## Clash Premium unable to access Internet

You can refer to these relevant discussions:

- [#432](https://github.com/thkx/clash/issues/432#issuecomment-571634905)
- [#2480](https://github.com/thkx/clash/issues/2480)
...
You're using Clash open-source edition. Rule Providers is currently only available in the [Premium core](https://github.com/thkx/clash/releases/tag/premium). (it's free)
