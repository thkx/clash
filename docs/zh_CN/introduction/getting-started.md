...
您可以在这里下载 Clash 的内核二进制文件: [https://github.com/hhhhhhhxx/clash/releases](https://github.com/hhhhhhhxx/clash/releases)
...
对于其他构建目标, 请查看 [Makefile](https://github.com/hhhhhhhxx/clash/blob/master/Makefile).