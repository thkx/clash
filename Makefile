...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/hhhhhhhxx/clash/constant.Version=$(VERSION)" \
		-X "github.com/hhhhhhhxx/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
